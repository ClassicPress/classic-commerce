...
class WC_Privacy_Erasers {
	...
	/**
	 * Finds and erases data which could be used to identify a person from Classic Commerce data assocated with an email address.
	 *
	...
	/**
	 * Remove personal data specific to Classic Commerce from an order object.
	 *
