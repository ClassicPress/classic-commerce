	...
	<tbody>
		<?php if ( 0 !== $zone->get_id() ) : ?>
			...
			<tr valign="top" class="">
				...
				<td class="forminp">
					<select multiple="multiple" data-attribute="zone_locations" id="zone_locations" name="zone_locations" data-placeholder="<?php esc_html_e( 'Select regions within this zone', 'classic-commerce' ); ?>" class="wc-shipping-zone-region-select chosen_select">
						<?php
