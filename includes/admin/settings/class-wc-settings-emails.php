		...
		$settings = apply_filters(
			'woocommerce_email_settings', array(
				...
				array(
					...
					'desc'  => __( 'Email notifications sent from WooCommerce are listed below. Click on an email to configure it.', 'classic-commerce' ),
					'type'  => 'title',
				...
				array(
					...
					'desc'     => __( 'How the sender name appears in outgoing WooCommerce emails.', 'classic-commerce' ),
				...
				array(
					...
					'desc'              => __( 'How the sender email appears in outgoing WooCommerce emails.', 'classic-commerce' ),
				...
				array(
					...
					'desc'  => sprintf( __( 'This section lets you customize the WooCommerce emails. <a href="%s" target="_blank">Click here to preview your email template</a>.', 'classic-commerce' ), wp_nonce_url( admin_url( '?preview_woocommerce_mail=true' ), 'preview-mail' ) ),
				...
				array(
					...
					'desc'        => __( 'The text to appear in the footer of WooCommerce emails.', 'classic-commerce' ) . ' ' . sprintf( __( 'Available placeholders: %s', 'classic-commerce' ), '{site_title}' ),
				...
				array(
					...
					'desc'     => sprintf( __( 'The base color for WooCommerce email templates. Default %s.', 'classic-commerce' ), '<code>#96588a</code>' ),
				...
				array(
					...
					/* translators: %s: default color */
					'desc'     => sprintf( __( 'The background color for WooCommerce email templates. Default %s.', 'classic-commerce' ), '<code>#f7f7f7</code>' ),
