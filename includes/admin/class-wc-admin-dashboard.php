	...
	class WC_Admin_Dashboard {
		...
		public function init() {
			if ( current_user_can( 'publish_shop_orders' ) && post_type_supports( 'product', 'comments' ) ) {
				wp_add_dashboard_widget( 'woocommerce_dashboard_recent_reviews', __( 'WooCommerce recent reviews', 'classic-commerce' ), array( $this, 'recent_reviews' ) );
			}
			wp_add_dashboard_widget( 'woocommerce_dashboard_status', __( 'WooCommerce status', 'classic-commerce' ), array( $this, 'status_widget' ) );
		...
		public function register_network_order_widget() {
			wp_add_dashboard_widget( 'woocommerce_network_orders', __( 'WooCommerce network orders', 'classic-commerce' ), array( $this, 'network_orders' ) );
		}
