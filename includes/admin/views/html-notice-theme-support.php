<?php
/**
 * TODO: Remove third party compartibility tracker links and add real links
...
<div id="message" class="updated woocommerce-message wc-connect">
	...
	<p><?php printf( __( '<strong>Your theme does not declare ClassicCommerce support</strong> &#8211; Please read our <a href="%1$s" target="_blank">integration</a> guide or check out our <a href="%2$s" target="_blank">Storefront</a> theme which is totally free to download and designed specifically for use with ClassicCommerce.', 'woocommerce' ), esc_url( apply_filters( 'woocommerce_docs_url', 'https://docs.woocommerce.com/document/third-party-custom-theme-compatibility/', 'theme-compatibility' ) ), esc_url( self_admin_url( 'theme-install.php?theme=storefront' ) ) ); ?></p>
	<p class="submit">
