...
<div id="message" class="updated woocommerce-message">
	...
	<p>
		...
		<?php printf( __( '<strong>Your theme (%s) contains outdated copies of some ClassicCommerce template files.</strong> These files may need updating to ensure they are compatible with the current version of ClassicCommerce. Suggestions to fix this:', 'woocommerce' ), esc_html( $theme['Name'] ) ); // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped ?>
		<ol>
			<li><?php esc_html_e( 'Update your theme to the latest version. If no update is available contact your theme author asking about compatibility with the current ClassicCommerce version.', 'woocommerce' ); ?></li>
