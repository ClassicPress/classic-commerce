...
class WC_Admin_Menus {
	...
	public function admin_menu() {
		...
		add_menu_page( __( 'Classic Commerce', 'classic-commerce' ), __( 'WooCommerce', 'classic-commerce' ), 'manage_woocommerce', 'woocommerce', null, WC()->plugin_url() . '/assets/images/classic-commerce-dashicon-white.svg', '55.5' );
