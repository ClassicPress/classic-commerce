...
class WC_Admin_Menus {
	...
	public function settings_menu() {
		$settings_page = add_submenu_page( 'woocommerce', __( 'WooCommerce settings', 'classic-commerce' ), __( 'Settings', 'classic-commerce' ), 'manage_woocommerce', 'wc-settings', array( $this, 'settings_page' ) );
	...
	public function status_menu() {
		add_submenu_page( 'woocommerce', __( 'WooCommerce status', 'classic-commerce' ), __( 'Status', 'classic-commerce' ), 'manage_woocommerce', 'wc-status', array( $this, 'status_page' ) );
	}
	...
	public function addons_menu() {
		...
		add_submenu_page( 'woocommerce', __( 'WooCommerce extensions', 'classic-commerce' ), $menu_title, 'manage_woocommerce', 'wc-addons', array( $this, 'addons_page' ) );
	}
	...
	public function add_nav_menu_meta_boxes() {
		add_meta_box( 'woocommerce_endpoints_nav_link', __( 'WooCommerce endpoints', 'classic-commerce' ), array( $this, 'nav_menu_links' ), 'nav-menus', 'side', 'low' );
	}
