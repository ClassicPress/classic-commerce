	...
	<div class="options_group show_if_external">
		...
		woocommerce_wp_text_input(
			array(
				...
				'label'       => __( 'Product URL', 'classic-commerce' ),
				'placeholder' => 'http://',
				'description' => __( 'Enter the external URL to the product.', 'classic-commerce' ),
			)
		);
		...
		woocommerce_wp_text_input(
			array(
				...
				'label'       => __( 'Button text', 'classic-commerce' ),
				'placeholder' => _x( 'Buy product', 'placeholder', 'classic-commerce' ),
				'description' => __( 'This text will be shown on the button linking to the external product.', 'classic-commerce' ),
			)
		);
		?>
	</div>
	...
	<div class="options_group pricing show_if_simple show_if_external hidden">
		...
		woocommerce_wp_text_input(
			array(
				...
				'label'     => __( 'Regular price', 'classic-commerce' ) . ' (' . get_woocommerce_currency_symbol() . ')',
				'data_type' => 'price',
			)
		);
		...
		woocommerce_wp_text_input(
			array(
				...
				'data_type'   => 'price',
				'label'       => __( 'Sale price', 'classic-commerce' ) . ' (' . get_woocommerce_currency_symbol() . ')',
				'description' => '<a href="#" class="sale_schedule">' . __( 'Schedule', 'classic-commerce' ) . '</a>',
			)
		);
		...
		echo '<p class="form-field sale_price_dates_fields">
				<label for="_sale_price_dates_from">' . esc_html__( 'Sale price dates', 'classic-commerce' ) . '</label>
				...
				<a href="#" class="description cancel_sale_schedule">' . esc_html__( 'Cancel', 'classic-commerce' ) . '</a>' . wc_help_tip( __( 'The sale will end at the beginning of the set date.', 'classic-commerce' ) ) . '
			</p>';
		...
		<div class="options_group show_if_simple show_if_external show_if_variable">
			...
			woocommerce_wp_select(
				array(
					...
					'label'       => __( 'Tax status', 'classic-commerce' ),
					'options'     => array(
					...
					'desc_tip'    => 'true',
					'description' => __( 'Define whether or not the entire product is taxable, or just the cost of shipping it.', 'classic-commerce' ),
				)
			);
