...
class WC_REST_Product_Variations_Controller extends WC_REST_Product_Variations_V2_Controller {
		...
		if ( isset( $request['attributes'] ) ) {
			...
			if ( ! $parent ) {
				return new WP_Error(
					...
					"woocommerce_rest_{$this->post_type}_invalid_parent", sprintf( __( 'Cannot set attributes due to invalid parent product.', 'classic-commerce' ), $variation->get_parent_id() ), array(
						'status' => 404,
					)
				);
			}
	...
	protected function set_variation_image( $variation, $image ) {
		...
		if ( ! wp_attachment_is_image( $attachment_id ) ) {
			...
			throw new WC_REST_Exception( 'woocommerce_variation_invalid_image_id', sprintf( __( '#%s is an invalid image ID.', 'classic-commerce' ), $attachment_id ), 400 );
		}
	...
	public function get_item_schema() {
		...
		$schema         = array(
			...
			'properties' => array(
				...
				'description'           => array(
					'description' => __( 'Variation description.', 'classic-commerce' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
				'permalink'             => array(
				...
				'status'                => array(
					'description' => __( 'Variation status.', 'classic-commerce' ),
					'type'        => 'string',
					'default'     => 'publish',
