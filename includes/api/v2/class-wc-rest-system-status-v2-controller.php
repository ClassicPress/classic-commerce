...
class WC_REST_System_Status_V2_Controller extends WC_REST_Controller {
		...
		$schema = array(
			...
			'properties' => array(
				...
				'theme'          => array(
					...
					'properties'  => array(
						...
						'version_latest'          => array(
							'description' => __( 'Latest version of theme.', 'classic-commerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						...
						'has_woocommerce_file'    => array(
							'description' => __( 'Does the theme have a woocommerce.php file?', 'classic-commerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
				...
				'settings'       => array(
					...
					'properties'  => array(
						'api_enabled'              => array(
							'description' => __( 'REST API enabled?', 'classic-commerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
	...
	public function get_environment_info() {
		...
		$post_response            = wp_safe_remote_post(
			...
			array(
				'timeout'     => 10,
				'user-agent'  => 'WooCommerce/3.5.3 (compatible; ClassicCommerce/' . WC()->cc_version . ')',
				'httpversion' => '1.1',
				'body'        => array(
