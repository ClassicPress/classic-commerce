	...
	public function get_tools() {
		$tools = array(
			'clear_transients'                   => array(
				'name'   => __( 'WooCommerce transients', 'classic-commerce' ),
			...
			'install_pages'                      => array(
				'name'   => __( 'Create default WooCommerce pages', 'classic-commerce' ),
				'button' => __( 'Create pages', 'classic-commerce' ),
				'desc'   => sprintf(
					'<strong class="red">%1$s</strong> %2$s',
					__( 'Note:', 'classic-commerce' ),
					__( 'This tool will install all the missing WooCommerce pages. Pages already defined and set up will not be replaced.', 'classic-commerce' )
				),
			),
			'delete_taxes'                       => array(
				'name'   => __( 'Delete WooCommerce tax rates', 'classic-commerce' ),
			...
			'db_update_routine'                  => array(
				...
				'desc'   => sprintf(
					'<strong class="red">%1$s</strong> %2$s',
					__( 'Note:', 'classic-commerce' ),
					__( 'This tool will update your WooCommerce database to the latest version. Please ensure you make sufficient backups before proceeding.', 'classic-commerce' )
				),
			)
		);
	...
	public function execute_tool( $tool ) {
		...
		switch ( $tool ) {
			...
			case 'install_pages':
				...
				$message = __( 'All missing WooCommerce pages successfully installed', 'classic-commerce' );
				break;
