	...
	public static function plugin_row_meta( $links, $file ) {
		if ( WC_PLUGIN_BASENAME === $file ) {
			$row_meta = array(
				...
				'support' => '<a href="' . esc_url( apply_filters( 'woocommerce_support_url', 'https://github.com/ClassicPress/classic-commerce/issues' ) ) . '" aria-label="' . esc_attr__( 'Visit issues  support section on github', 'classic-commerce' ) . '" target="_blank" rel="noopener noreferrer">' . esc_html__( 'Support', 'classic-commerce' ) . '</a>',
			);
